...
class SystemToolbar(QtWidgets.QWidget):
    ...
    def set_live_traces(self, plot_name, traces):
        count = len(traces)
        self.live_button.setText(f"Linked: {count}")
        ...
        if not traces:
            ...
            menu.addSeparator()
            clear_action = menu.addAction("Clear linked traces")
    ...
    def _build_options_menu(self):
        ...
        layout.addRow("Pen", self.pen_combo)
    ...
    def _emit_plot_request(self):
        ...
        pen = self.pen_combo.currentData()
        options = {
    ...
    def _build_toolbar(self):
        ...
        self.plot_kind_combo.setMinimumWidth(50)
        self.plot_kind_combo.setMaximumWidth(120)
        ...
        self.live_button.setText("Linked: 0")
        self.live_button.setToolTip("Linked traces for the current plot")
        ...
        self.live_check = QtWidgets.QCheckBox("Link")
        ...
        self.pen_combo = QtWidgets.QComboBox()
        for label, value in PEN_OPTS:
            self.pen_combo.addItem(label, value)
        self.pen_combo.setToolTip("Plot pen colour")
        ...
        self.crossing_value_spin.setRange(-1000000.0, 1000000.0)
        ...
        self.fit_t_min_spin.setRange(-1000000.0, 1000000.0)
        ...
        self.fit_t_max_spin.setRange(-1000000.0, 1000000.0)
        ...
        self.run_button.setIcon(QtGui.QIcon.fromTheme("system-run"))
        self.run_button.setToolTip("Run plot")
        self.run_button.clicked.connect(self._emit_plot_request)

        toolbar_layout.addWidget(self.options_button)
        toolbar_layout.addWidget(self.run_button)

        for button in self.live_button, self.options_button, self.run_button:
